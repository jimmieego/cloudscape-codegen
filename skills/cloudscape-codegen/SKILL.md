...
description: Generate Cloudscape Design System React + TypeScript UI code and page scaffolds with Cloudscape-first patterns, accessibility defaults, and production-ready state handling. Use when users ask for Cloudscape pages, forms, tables, wizards, or Cloudscape migrations.
license: MIT
metadata:
  author: jimmie
  version: "0.2.0"
...
Use these for validation and regression checks:

- `references/checks.md`
- `references/cloudscape-prompts.md`
...
- `https://github.com/aws-samples/cloudscape-examples/tree/main/empty-vite`
- `https://github.com/aws-samples/cloudscape-examples/tree/main/basic-vite`
- `https://github.com/aws-samples/cloudscape-examples/tree/main/chat-ui-vite`
